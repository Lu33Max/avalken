...
public class IT_CrystalBlue extends InteractiveTile {

    GamePanel gp;
    int counter;
    boolean lock;

    public IT_CrystalBlue(GamePanel gp, int col, int row) {
        super(gp, col, row);
        this.gp = gp;
        ...
        down1 = setup("/interactiveTiles/CrystalBlue", 1, 1);
        destructible = true;
    }
    ...
    public InteractiveTile getDestroyedForm() {
        return new IT_CrystalRed(gp, worldX / gp.getTILE_SIZE(), worldY / gp.getTILE_SIZE());
    }
}
